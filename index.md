...
Welcome to my portfolio! I am a **Freshman at University of Wisconsin-Madison** double majoring in **Data Science & Economics**.
...
<style>
  /* Nút kêu gọi hành động (CTA) cực cháy ở trang chủ */
  .btn-cta-project {
    display: inline-flex;
    align-items: center;
    gap: 8px;
...
### 🛠️ Tech Stack
* **Languages:** Python, SQL, R, HTML, MD
