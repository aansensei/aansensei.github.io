...
.col-left::-webkit-scrollbar{width:4px;}.col-left::-webkit-scrollbar-thumb{background:rgba(201,162,39,.3);border-radius:10px;}
...
.toc-list{list-style:none;padding:0;margin:0;}.toc-list li{margin-bottom:10px;}
...
.col-main h1{font-family:'Cinzel Decorative',serif!important;font-size:1.2rem!important;color:#f0c84a!important;text-shadow:0 0 18px rgba(201,162,39,.4)!important;border-bottom:1px solid rgba(201,162,39,.2);padding-bottom:14px;margin-top:0;}
...
.col-main img{border-radius:12px;box-shadow:0 5px 20px rgba(0,0,0,.5);margin:18px 0;max-width:100%;display:block;}
.col-main p,.col-main ul,.col-main ol{margin-bottom:14px;}.col-main ul{padding-left:20px;}.col-main li{margin-bottom:8px;}
...
.cover-img{width:100%;border-radius:12px;margin-bottom:18px;box-shadow:0 0 22px rgba(0,0,0,.6),0 0 0 1px rgba(201,162,39,.12);}
...
.btn-neon-link{background:linear-gradient(45deg,#c94f7c,#7209b7);box-shadow:0 4px 14px rgba(114,9,183,.4);}
.btn-neon-link:hover{transform:translateY(-3px);box-shadow:0 0 20px rgba(201,79,124,.6);}
...
<div class="project-grid">
  ...
  <div class="glass-box col-main">
    ...
    <p>The semiconductor industry is the backbone of modern technology, serving as the prerequisite for advancements in AI, IoT, and cloud storage. As the global market value pushes toward 800 billion USD, a massive bottleneck has emerged: a severe shortage of skilled labor. I wanted to understand how this global crisis impacts Vietnam and what actionable lessons we could draw from established tech giants like Taiwan.</p>

    <h3 id="key-highlights-and-findings">Key Highlights and Findings</h3>
    <ul>
      <li><strong>A Global Talent Drought:</strong> The talent shortage is worldwide — the US projects a deficit of 70,000 to 90,000 jobs in coming years.</li>
      <li><strong>Vietnam's Supply and Demand Gap:</strong> Vietnam has ~5,500 engineers but needs 5,000–10,000 new engineers annually; domestic training meets only ~20% of demand.</li>
      <li><strong>The Taiwan Blueprint:</strong> TSMC's success was rooted in promoting indigenous research and creating a geographically dense ecosystem around Hsinchu Science Park.</li>
      <li><strong>Educational Bottlenecks:</strong> Universities struggle with high costs for semiconductor labs and a lack of industry experts to teach specialized subjects.</li>
    </ul>

    <h3 id="results-and-policy-implications">Results and Policy Implications</h3>
    <ul>
      <li><strong>University and Industry Synergy:</strong> Mixed laboratories on campuses, created in collaboration with industry.</li>
      <li><strong>Targeted Output Standards:</strong> Educational institutions must align with international requirements.</li>
      <li><strong>Ecosystem Development:</strong> A tech ecosystem connecting universities, companies, and government to optimize resources.</li>
    </ul>
    <p><em>Working on this paper bridged the gap between academic research and real-world economic strategy, highlighting what it takes to build a workforce for the future.</em></p>
  </div>
