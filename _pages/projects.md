...
.bookshelf::before{content:'';position:absolute;inset:0;z-index:2;pointer-events:none;background:radial-gradient(ellipse 46% 30% at 50% 0%,rgba(255,240,195,.30) 0%,transparent 58%),radial-gradient(ellipse 130% 65% at 50% 122%,rgba(0,0,0,.68) 0%,transparent 55%);}
...
body.an-day-mode .bookshelf::before{background:radial-gradient(ellipse 46% 30% at 50% 0%,rgba(255,250,235,.6) 0%,transparent 58%),radial-gradient(ellipse 130% 65% at 50% 122%,rgba(60,35,10,.4) 0%,transparent 55%);}
