...
body.an-day-mode .bookshelf::before{background:radial-gradient(ellipse 46% 30% at 50% 0%,rgba(255,250,235,.6) 0%,transparent 58%),radial-gradient(ellipse 130% 65% at 50% 122%,rgba(60,35,10,.4) 0%,transparent 55%),linear-gradient(90deg,rgba(60,35,10,.28) 0%,rgba(60,35,10,.08) 12%,transparent 24%,transparent 76%,rgba(60,35,10,.08) 88%,rgba(60,35,10,.28) 100%),linear-gradient(180deg,rgba(40,22,6,.24) 0%,transparent 10%,transparent 90%,rgba(40,22,6,.16) 100%);}
