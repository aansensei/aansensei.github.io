...
body.an-day-mode .bookshelf{background-color:#c9975a!important;background-image:url("{{ '/assets/images/dong-son-medallion-day.svg' | relative_url }}"),repeating-linear-gradient(90deg,rgba(255,255,255,.05) 0px,rgba(255,255,255,.05) 1px,transparent 1px,transparent 38px),radial-gradient(ellipse 90% 70% at 50% 8%,rgba(255,235,190,.4) 0%,transparent 70%),linear-gradient(160deg,#d9a866 0%,#a97640 55%,#8a5a2e 100%)!important;background-repeat:no-repeat,repeat,no-repeat,no-repeat!important;background-size:820px 820px,auto,auto,auto!important;background-position:center center,0 0,0 0,0 0!important;border-image:linear-gradient(180deg,#f0d9a8 0%,#d4a35c 15%,#a97a3a 45%,#7a5424 75%,#4a3312 100%) 1!important;box-shadow:inset 0 0 150px rgba(60,35,10,.58),inset 0 55px 75px -20px rgba(60,35,10,.5),inset 0 -30px 45px -15px rgba(40,22,6,.45),inset 0 8px 12px -4px rgba(40,22,6,.6),inset 12px 0 20px -10px rgba(40,22,6,.5),inset -12px 0 20px -10px rgba(40,22,6,.5),0 18px 40px rgba(60,35,10,.35),0 0 0 1px rgba(184,134,11,.15)!important;}
